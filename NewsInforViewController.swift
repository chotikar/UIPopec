...
class NewsInforViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    @objc let scoll : UIScrollView = {
        var sc = UIScrollView()
        sc.frame = CGRect(x: 0, y: 0, width: scWid, height: scHei)
        return sc
    }()
    @IBOutlet var SuggestionNewsCollection: UICollectionView!
    @objc var mainImage : UIImageView!
    @objc var newsTitle : UILabel!
    @objc var newsSubtitle : UILabel!
    @objc var location : UIView!
    @objc var news : UITextView!
    @objc var scollSuggestNews : UIScrollView!
    @objc var suggestNews1 : UIView!
    @objc var suggestNews1Title : UILabel!
    @objc var suggestNews2 : UIView!
    @objc var suggestNews2Title : UILabel!
    @objc var suggestNews3 : UIView!
    @objc var suggestNews3Title : UILabel!
    @objc var newssugestiontitle : String = ""
    ...
    @objc func setcv(contentSize : CGFloat){
        self.SuggestionNewsCollection.frame = CGRect(x: scWid*0.03, y: contentSize - 40, width: scWid*0.95, height: scHei*0.2)
        self.scoll.addSubview(self.SuggestionNewsCollection)
        self.scoll.contentSize = CGSize(width: scWid, height: contentSize+scHei*0.2 + 20)
    ...
    @objc func drawNewsInformation() -> CGFloat {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.sugNewsImg.sd_setImage(with: NSURL(string: facNewsList[indexPath.row].imageURL)! as URL, placeholderImage: UIImage(named:"abaccl"))
        cell.sugNewsTitle.frame = CGRect(x: scHei*0.01, y: scHei*0.115, width: scHei*0.19, height: scHei*0.08)
    ...
    @objc func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        vc.showNewsModel = facNewsList[indexPath.row]
        vc.facNewsList = facNewsList
